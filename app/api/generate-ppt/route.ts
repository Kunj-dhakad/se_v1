...
//     return ""; // fallback (skip broken image)
//   }
// }
...
//       /* Background */
//       if (slide.background) {
//         // sld.background = { color: slide.background.replace("#", "") };
//         sld.background = { color: slide.background || "000000" };
//       }
...
//             /* TEXT STYLE */
//             fontSize: data.fontSize || 24,
//             color: (data.color || "#ffffff").replace("#", ""),
//             fontFace: data.fontFamily || "Inter",
//             bold: data.fontWeight === "bold" || Number(data.fontWeight) >= 600,
//             italic: data.fontStyle === "italic",
//             underline: data.textDecoration === "underline",
//             strike: data.textDecoration === "line-through",
//             align: data.align || "left",
//             lineSpacingMultiple: data.lineHeight || 1,
//             charSpacing: data.letterSpacing || 0,
//           });
//         }

//         /* ------------------------------------------------------
//            IMAGE ELEMENT (URL → Base64)
//         -------------------------------------------------------- */
//         if (data.type === "image" && data.src) {
//           let base64 = data.src;
...
//             w: pxToIn(data.width),
//             h: pxToIn(data.height),
//             fill: { color: data.fill?.replace("#", "") || "FFFFFF" },
//             line: {
//               color: data.stroke?.replace("#", "") || "000000",
//               width: data.strokeWidth || 0,
//             },
//             rectRadius: data.borderRadius || 0,
//           });
//         }

//         /* ------------------------------------------------------
//            SVG (convert to image automatically)
//         -------------------------------------------------------- */
//         if (data.type === "svg") {
//           let base64 = data.svg;
...
//               Buffer.from(data.svg).toString("base64");
//           }
